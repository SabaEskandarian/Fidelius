...
sgx_status_t SGX_UBRIDGE(SGX_NOCONVENTION, enc_make_http_request, (const char* method, const char* url, const char* headers, const char* request_data, int* ret_code));
