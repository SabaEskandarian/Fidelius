...
sgx_status_t SGX_CDECL enc_make_http_request(sgx_status_t* retval, const char* method, const char* url, const char* headers, const char* request_data, int* ret_code);
